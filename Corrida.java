 ...
 * @version 1.0
 */
public class Corrida extends Actividade implements Altimetria, Meteorologia, Distancia, Tempo
{
    ...
    * 1 - Parametrizado
    */
    public Corrida(String desp, double d, double km, double min, double amax, double des, double sub, String m)
    {
        this.desporto = desp;
        this.duracao = d;
